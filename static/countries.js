export const allCountries = [
  ...
  { name: 'Bolivia (Plurinational State of)', 'alpha-3': 'BOL', 'country-code': '068' },
  { name: 'Bonaire, Sint Eustatius and Saba', 'alpha-3': 'BES', 'country-code': '535' },
  ...
  { name: 'British Indian Ocean Territory', 'alpha-3': 'IOT', 'country-code': '086' },
  ...
  { name: 'Congo, Democratic Republic of the', 'alpha-3': 'COD', 'country-code': '180' },
  ...
  { name: 'Falkland Islands (Malvinas)', 'alpha-3': 'FLK', 'country-code': '238' },
  ...
  { name: 'French Southern Territories', 'alpha-3': 'ATF', 'country-code': '260' },
  ...
  { name: 'Heard Island and McDonald Islands', 'alpha-3': 'HMD', 'country-code': '334' },
  ...
  { name: 'Iran (Islamic Republic of)', 'alpha-3': 'IRN', 'country-code': '364' },
  ...
  { name: "Korea (Democratic People's Republic of)", 'alpha-3': 'PRK', 'country-code': '408' },
  ...
  { name: "Lao People's Democratic Republic", 'alpha-3': 'LAO', 'country-code': '418' },
  ...
  { name: 'Micronesia (Federated States of)', 'alpha-3': 'FSM', 'country-code': '583' },
  ...
  { name: 'Saint Helena, Ascension and Tristan da Cunha', 'alpha-3': 'SHN', 'country-code': '654' },
  { name: 'Saint Kitts and Nevis', 'alpha-3': 'KNA', 'country-code': '659' },
  { name: 'Saint Lucia', 'alpha-3': 'LCA', 'country-code': '662' },
  { name: 'Saint Martin (French part)', 'alpha-3': 'MAF', 'country-code': '663' },
  { name: 'Saint Pierre and Miquelon', 'alpha-3': 'SPM', 'country-code': '666' },
  { name: 'Saint Vincent and the Grenadines', 'alpha-3': 'VCT', 'country-code': '670' },
  ...
  { name: 'Sint Maarten (Dutch part)', 'alpha-3': 'SXM', 'country-code': '534' },
  ...
  { name: 'South Georgia and the South Sandwich Islands', 'alpha-3': 'SGS', 'country-code': '239' },
  ...
  { name: 'Taiwan, Province of China', 'alpha-3': 'TWN', 'country-code': '158' },
  { name: 'Tajikistan', 'alpha-3': 'TJK', 'country-code': '762' },
  { name: 'Tanzania, United Republic of', 'alpha-3': 'TZA', 'country-code': '834' },
  ...
  { name: 'United Kingdom of Great Britain and Northern Ireland', 'alpha-3': 'GBR', 'country-code': '826' },
  ...
  { name: 'Venezuela (Bolivarian Republic of)', 'alpha-3': 'VEN', 'country-code': '862' },
